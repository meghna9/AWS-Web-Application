...
$_SESSION['email'] = "mlaveti@hawk.iit.edu";
echo "\n" . $_SESSION['email'] ."\n";
...
$rdsresult = $rdsclient->describeDBInstances([
    'DBInstanceIdentifier' => 'meghnalaveti9'
]);
...
$link = mysqli_connect($endpoint,"controller9","meghna999","meghnalaveti9") or die("Error " . mysqli_error($link));
